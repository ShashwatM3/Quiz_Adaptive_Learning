...
easy = {"How much is 65-43?": 22, "The square root of 144?": 12, "How much is 222+83?": 305, "Total degrees in the right angle?": 90, "What number should be added to 66 to get 121 as a sum?": 55,
        "what is the cube of 5": 125, "3/5th of 100 is?": 60, "The remainder of 21 divided 7 is?": 0, "What is the cube of 7?": 343}

medium = {"Solve: (2x + 5)/(x + 4) = 1 Give the value of x": -1, "Solve: 6x - 19 = 3x - 10 Give the value of x": 3, "A fruit seller had some apples. He sells 40% apples and still has 420 apples. How many apples did he originally have?": 700, "What percentage of numbers from 1 to 70 have 1 or 9 in the unit's digit?": 20, "In a bag full of small balls, 1/4 of these balls are green, 1/8 are blue, 1/12 are yellow and the remaining 26 white. How many balls are blue?": 6, "In a school 50% of the students are younger than 10, 1/20 are 10 years old and 1/10 are older than 10 but younger than 12, the remaining 70 students are 12 years or older. How many students are 10 years old?": 10,
...
df = pd.read_csv(
    r"C:\Users\Gobu\OneDrive\Desktop\project\PROJECT_DATASET.csv")
